...
// When the window has finished loading create our google map below
        ...
        // https://maps.googleapis.com/maps/api/js?key=AIzaSyBDQnrAQzneJc7RsZ2cUs33vMsyqHEMtlA&callback=initMap
            function init() {
                var address = "350 Fifth Avenue, New York, NY 10118", lat, long;
                $.ajax({
                  url:"https://maps.googleapis.com/maps/api/geocode/json?address="+address+"&sensor=false&key=AIzaSyBDQnrAQzneJc7RsZ2cUs33vMsyqHEMtlA",
                  type: "POST",
